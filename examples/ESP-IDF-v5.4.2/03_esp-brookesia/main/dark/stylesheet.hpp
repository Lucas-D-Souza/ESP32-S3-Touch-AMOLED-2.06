...
constexpr Display::Data STYLESHEET_410_502_DARK_DISPLAY_DATA = {
    .status_bar = {
        .data = STYLESHEET_410_502_DARK_STATUS_BAR_DATA,
        .visual_mode = StatusBar::VisualMode::SHOW_FIXED,
    },
    .navigation_bar = {
        .data = STYLESHEET_410_502_DARK_NAVIGATION_BAR_DATA,
        .visual_mode = NavigationBar::VisualMode::HIDE,
    },
    .app_launcher = {
        .data = STYLESHEET_410_502_DARK_APP_LAUNCHER_DATA,
        .default_image = gui::StyleImage::IMAGE(&esp_brookesia_image_small_app_launcher_default_98_98),
    },
    .recents_screen = {
        .data = STYLESHEET_410_502_DARK_RECENTS_SCREEN_DATA,
...
constexpr Manager::Data STYLESHEET_410_502_DARK_MANAGER_DATA = {
    .gesture = STYLESHEET_410_502_DARK_GESTURE_DATA,
...
constexpr Stylesheet STYLESHEET_410_502_DARK = {
    .core = STYLESHEET_410_502_DARK_CORE_DATA,
    .display = STYLESHEET_410_502_DARK_DISPLAY_DATA,
    .manager = STYLESHEET_410_502_DARK_MANAGER_DATA,
};

} // namespace esp_brookesia::systems::phone

#define MEU_RELOGIO_DARK_STYLESHEET() esp_brookesia::systems::phone::STYLESHEET_410_502_DARK