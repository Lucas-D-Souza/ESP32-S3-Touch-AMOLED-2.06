...
#define CONFIG_ESP_BROOKESIA_GUI_ENABLE_SQUARELINE 1
#define CONFIG_ESP_BROOKESIA_SQUARELINE_ENABLE_UI_COMP 1
#define CONFIG_ESP_BROOKESIA_SQUARELINE_ENABLE_UI_HELPERS 1
#define CONFIG_ESP_BROOKESIA_ENABLE_SYSTEMS 1
#define CONFIG_ESP_BROOKESIA_SYSTEMS_ENABLE_PHONE 1
#define CONFIG_ANIM_PLAYER_DEFAULT_FPS 30
#define CONFIG_CU_DIAGNOSTICS_COLOR_ALWAYS 1
#define CONFIG_BOOST_CXX_FEATURE_ENABLED 1
...
#define CONFIG_ESP_UTILS_CONF_FILE_SKIP 1
#define CONFIG_ESP_UTILS_CHECK_HANDLE_WITH_ERROR_LOG 1
#define CONFIG_ESP_UTILS_CONF_CHECK_HANDLE_METHOD 1
#define CONFIG_ESP_UTILS_CONF_LOG_IMPL_ESP 1
#define CONFIG_ESP_UTILS_CONF_LOG_IMPL_TYPE 1
#define CONFIG_ESP_UTILS_CONF_LOG_LEVEL_INFO 1
#define CONFIG_ESP_UTILS_CONF_LOG_LEVEL 1
#define CONFIG_ESP_UTILS_CONF_MEM_GEN_ALLOC_DEFAULT_ENABLE 1
#define CONFIG_ESP_UTILS_CONF_MEM_GEN_ALLOC_TYPE_STDLIB 1
#define CONFIG_ESP_UTILS_CONF_MEM_GEN_ALLOC_TYPE 0
#define CONFIG_ESP_UTILS_CONF_PLUGIN_SUPPORT 1
...
#define CONFIG_ESP_AUDIO_SIMPLE_PLAYER_HTTP_EN 1
#define CONFIG_ESP_AUDIO_SIMPLE_PLAYER_FILE_EN 1
#define CONFIG_ESP_AUDIO_SIMPLE_PLAYER_EMBED_FLASH_EN 1
#define CONFIG_ESP_AUDIO_SIMPLE_PLAYER_RESAMPLE_EN 1
#define CONFIG_AUDIO_SIMPLE_PLAYER_RESAMPLE_DEST_RATE 48000
...
#define CONFIG_BSP_DISPLAY_LVGL_BUF_HEIGHT 100
